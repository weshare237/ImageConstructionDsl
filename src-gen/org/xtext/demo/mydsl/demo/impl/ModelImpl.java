...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
   ...
   * @ordered
   */
  protected EList<Image> elements;
   ...
   */
  @Override
  public EList<Image> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Image>(Image.class, this, DemoPackage.MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case DemoPackage.MODEL__ELEMENTS:
        getElements().clear();
        getElements().addAll((Collection<? extends Image>)newValue);
        return;
    }
